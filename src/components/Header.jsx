...
import { getUserDataFromSession, getUserData } from "../utils/getUserData";
import { getClientsData } from "../utils/getClientData";

const Header = ({ userFromSession }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const userData = await getUserData(userFromSession.$id);
        setUserData(userData);

        const clientData = await getClientsData(userData.clients);
    ...
    <div className="header">
      <div className="header-container">
        <svg
          ...
          className="settings-icon h-8 md:h-10"
