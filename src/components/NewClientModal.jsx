  ...
  return (
    <div>
      ...
      {isOpen && (
        ...
        >
          <div
            className=" modalClient p-8 bg-neutral-100 rounded-2xl shadow-lg flex flex-col w-screen max-w-96"
            ref={modalRef}
          >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col">
              ...
              <button
                type="submit"
                className="bg-lime-500 hover:bg-lime-700 text-white font-bold py-2 px-4 rounded my-2 mx-4"
              >
                Save
              </button>
              <button
                type="button"
                className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded my-2 mx-4"
                onClick={closeModal}
              >
                Cancel
              </button>
